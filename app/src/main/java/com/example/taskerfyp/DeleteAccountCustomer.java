...
public class DeleteAccountCustomer extends AppCompatActivity {
    ...
    public void showAlertDialog() {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(DeleteAccountCustomer.this);
        builder.setMessage("All Your Data Will Be Deleted.\nDo you want to continue?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(DeleteAccountCustomer.this, "Account Deletion Cancel", Toast.LENGTH_LONG).show();
                    }
                });
        builder.create().show();
    }
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(DeleteAccountCustomer.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
