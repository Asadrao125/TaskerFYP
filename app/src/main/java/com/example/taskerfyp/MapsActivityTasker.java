        ...
        LocationListener
{
   ...
   SwitchCompat switchButton;
    ...
    private void findDriver() {
        DatabaseReference drivers = FirebaseDatabase.getInstance().getReference("Customer_lat_lng");
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                if(!isDriverFound)
                {
                    ...
                    Toast.makeText(MapsActivityTasker.this, ""+key, Toast.LENGTH_SHORT).show();
                }
            }
                        ...
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                              CustomerUser customerUser = dataSnapshot.getValue(CustomerUser.class);
                                ...
                                Toast.makeText(MapsActivityTasker.this, ""+key, Toast.LENGTH_LONG).show();

                                mMap.addMarker(new MarkerOptions()
                                        .position(new LatLng(location.latitude , location.longitude))
                                        .flat(true)
                                        .title(customerUser.getCustomerUsername())
