...
public class RatingsActivityTasker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ratings_tasker);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    ratingsAdapter = new RatingsAdapter(getApplicationContext(), list);
                    recyclerView.setAdapter(ratingsAdapter);
                } else {
                    Toast.makeText(getApplicationContext(), "No Rating To Show", Toast.LENGTH_SHORT).show();
                }
            }
